...
factionList = {
	...
	{ "corsec", true, "afarathu,followers_of_lord_nyax,monumenter,rogue_corsec,lost_aqualish,hutt", "beldonnas_league", 1.0 },
	...
	{ "naboo_security_force", true, "borvo,naboo_pirate,plasma_thief,swamp_rat,trade_federation,hutt", "", 1.0 },
	{ "narmle", true, "kobola,spice_collective,hutt", "restuss", 1.0 },
	{ "nightsister", true, "mtn_clan,imperial", "", 1.0 },
	{ "nym", true, "bloodrazor,canyon_corsair,hutt", "", 1.0 },
