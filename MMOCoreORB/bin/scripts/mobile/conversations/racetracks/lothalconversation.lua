lothal_conversationtemplate = ConvoTemplate:new {
	initialScreen = "lothal_initial",
	templateType = "Lua",
	luaClassHandler = "lothal_racetrack_convo_handler",
	screens = {}
}

lothal_initial = ConvoScreen:new {
	id = "lothal_initial",
...
lothal_conversationtemplate:addScreen(lothal_initial);
...
lothal_conversationtemplate:addScreen(cs_jsPlumb_1_29);
...
lothal_conversationtemplate:addScreen(cs_jsPlumb_1_90);
...
lothal_conversationtemplate:addScreen(cs_jsPlumb_1_116);
...
lothal_conversationtemplate:addScreen(cs_jsPlumb_1_142);
...
lothal_conversationtemplate:addScreen(cs_jsPlumb_1_181);
...
lothal_conversationtemplate:addScreen(cs_jsPlumb_1_207);
...
lothal_conversationtemplate:addScreen(cs_jsPlumb_1_233);
addConversationTemplate("lothal_conversationtemplate", lothal_conversationtemplate);