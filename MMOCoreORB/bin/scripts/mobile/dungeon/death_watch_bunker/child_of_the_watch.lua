child_of_the_watch = Creature:new {
	objectName = "@mob/creature_names:child_of_the_watch",
	...
	reactionStf = "@npc_reaction/mandalorian",
...
CreatureTemplates:addCreatureTemplate(child_of_the_watch, "child_of_the_watch")
