coruscant_security = Creature:new {
	--objectName = "a Coruscant Lower City Security Officer",
	--randomNameType = NAME_GENERIC,
	--randomNameTag = true,
	customName = "a Coruscant Lower City Security Officer",
...
CreatureTemplates:addCreatureTemplate(coruscant_security, "coruscant_security")
