...
function EmperorsRetreatScreenPlay:spawnMobiles()
	...
	-- Inside
	local pNpc = spawnMobile("naboo", "rebel_trooper", 120, 11.2, 0.2, -31.5, 0, 1418874)
	self:setMoodString(pNpc, "npc_imperial")

	pNpc = spawnMobile("naboo", "rebel_trooper", 120, 14.8, 0.2, -31.5, 0, 1418874)
	self:setMoodString(pNpc, "npc_imperial")

	pNpc = spawnMobile("naboo", "rebel_trooper", 120, 10.8, 20, -27.2, 180, 1418886)
	self:setMoodString(pNpc, "npc_imperial")

	pNpc = spawnMobile("naboo", "rebel_trooper", 120, 15.3, 20, -27.2, 180, 1418886)
	self:setMoodString(pNpc, "npc_imperial")
	...
	pNpc = spawnMobile("naboo", "rebel_trooper", 120, -0.5, 0.2, -23.6, 76, 1418874)
	self:setMoodString(pNpc, "conversation")

	pNpc = spawnMobile("naboo", "rebel_trooper", 120, 0.7, 0.2, -23.5, -20, 1418874)
	self:setMoodString(pNpc, "conversation")

	--Guard Towers
	spawnMobile("naboo", "rebel_trooper", 450, 2536.8, 296, -3881.4, -90, 0)
	spawnMobile("naboo", "rebel_trooper", 450, 2536.8, 296, -3885.5, -90, 0)

	spawnMobile("naboo", "rebel_trooper", 450, 2551, 352, -3647, -125, 0)
	spawnMobile("naboo", "rebel_trooper", 450, 2553.2, 352, -3650.7, -125, 0)

	spawnMobile("naboo", "rebel_trooper", 450, 2342, 392, -3561.1, 145, 0)
	spawnMobile("naboo", "rebel_trooper", 450, 2345.3, 392, -3559, 145, 0)

	spawnMobile("naboo", "rebel_trooper", 450, 2175.6, 362, -3698, 133, 0)
	spawnMobile("naboo", "rebel_trooper", 450, 2178, 362, -3695.1, 133, 0)

	spawnMobile("naboo", "rebel_trooper", 450, 1711.5, 385, -3676, 130, 0)
	spawnMobile("naboo", "rebel_trooper", 450, 1714.6, 385, -3673.6, 130, 0)

	spawnMobile("naboo", "rebel_trooper", 450, 1909, 395, -4020.8, 20, 0)
	spawnMobile("naboo", "rebel_trooper", 450, 1905.3, 395, -4018.9, 20, 0)

	spawnMobile("naboo", "rebel_trooper", 450, 2122.8, 294, -4180.9, -15, 0)
	spawnMobile("naboo", "rebel_trooper", 450, 2118.9, 294, -4181.4, -15, 0)

	spawnMobile("naboo", "rebel_trooper", 450, 2371.8, 325, -4095.5, 0, 0)
	spawnMobile("naboo", "rebel_trooper", 450, 2367.7, 325, -4095.5, 0, 0)
	...
	spawnMobile("naboo", "rebel_trooper", 450, 2433.3, 292, -3968.4, 4, 0)
	spawnMobile("naboo", "rebel_trooper", 450, 2452, 292, -3912.8, -170, 0)
	spawnMobile("naboo", "rebel_trooper", 450, 2434.47, 292, -3932.06, 90, 0)
	spawnMobile("naboo", "rebel_trooper", 450, 2437.01, 292, -3947.8, 147, 0)
	spawnMobile("naboo", "rebel_trooper", 450, 2411.91, 292, -3986.99, -115, 0)
	spawnMobile("naboo", "rebel_pilot", 450, 2432.33, 292, -3887.25, -131, 0)
