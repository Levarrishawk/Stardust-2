...
object_draft_schematic_armored_clothing_armor_segment_armor_weaver_advanced = object_draft_schematic_armored_clothing_shared_armor_segment_armor_weaver_advanced:new {

	templateType = DRAFTSCHEMATIC,

	customObjectName = "Advanced Armor Weaving Segment",
	...
	targetTemplate = "object/tangible/component/armored_clothing/armor_segment_armor_weaver_advanced.iff",

	additionalTemplates = {}
}
ObjectTemplates:addTemplate(object_draft_schematic_armored_clothing_armor_segment_armor_weaver_advanced, "object/draft_schematic/armored_clothing/armor_segment_armor_weaver_advanced.iff")
