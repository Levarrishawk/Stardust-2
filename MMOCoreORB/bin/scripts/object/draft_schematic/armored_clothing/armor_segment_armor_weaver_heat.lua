...
object_draft_schematic_armored_clothing_armor_segment_armor_weaver_heat = object_draft_schematic_armored_clothing_shared_armor_segment_armor_weaver_heat:new {

	templateType = DRAFTSCHEMATIC,

	customObjectName = "Heat Armor Weaving Segment",
	...
	targetTemplate = "object/tangible/component/armored_clothing/armor_segment_armor_weaver_heat.iff",

	additionalTemplates = {}
}
ObjectTemplates:addTemplate(object_draft_schematic_armored_clothing_armor_segment_armor_weaver_heat, "object/draft_schematic/armored_clothing/armor_segment_armor_weaver_heat.iff")
