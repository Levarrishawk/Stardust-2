...
object_draft_schematic_armored_clothing_armor_segment_armor_weaver_blast = object_draft_schematic_armored_clothing_shared_armor_segment_armor_weaver_blast:new {

	templateType = DRAFTSCHEMATIC,

	customObjectName = "Blast Armor Weaving Segment",
	...
	targetTemplate = "object/tangible/component/armored_clothing/armor_segment_armor_weaver_blast.iff",

	additionalTemplates = {}
}
ObjectTemplates:addTemplate(object_draft_schematic_armored_clothing_armor_segment_armor_weaver_blast, "object/draft_schematic/armored_clothing/armor_segment_armor_weaver_blast.iff")
