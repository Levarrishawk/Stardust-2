...
object_draft_schematic_armor_armor_segment_armor_heat = object_draft_schematic_armor_shared_armor_segment_armor_heat:new {
	...
	targetTemplate = "object/tangible/component/armor/armor_segment_armor_heat.iff",

	additionalTemplates = {}
}
ObjectTemplates:addTemplate(object_draft_schematic_armor_armor_segment_armor_heat, "object/draft_schematic/armor/armor_segment_armor_heat.iff")
