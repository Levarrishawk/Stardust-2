object_draft_schematic_armor_armor_appearance_mandalorian_imperial_bicep_l = object_draft_schematic_armor_shared_armor_appearance_mandalorian_imperial_bicep_l:new {
   ...
   customObjectName = "Imperial Mandalorian Armor Left Bicep",
   ...
   targetTemplate = "object/tangible/wearables/armor/armor_appearance_mandalorian_imperial_bicep_l.iff",
