object_draft_schematic_armor_armor_appearance_mandalorian_imperial_bicep_r = object_draft_schematic_armor_shared_armor_appearance_mandalorian_imperial_bicep_r:new {
   ...
   customObjectName = "Imperial Mandalorian Armor Right Bicep",
   ...
   targetTemplate = "object/tangible/wearables/armor/armor_appearance_mandalorian_imperial_bicep_r.iff",
