...
object_draft_schematic_armor_armor_segment_armor_blast = object_draft_schematic_armor_shared_armor_segment_armor_blast:new {
	...
	targetTemplate = "object/tangible/component/armor/armor_segment_armor_blast.iff",

	additionalTemplates = {}
}
ObjectTemplates:addTemplate(object_draft_schematic_armor_armor_segment_armor_blast, "object/draft_schematic/armor/armor_segment_armor_blast.iff")
