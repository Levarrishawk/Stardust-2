object_draft_schematic_armor_armor_appearance_mandalorian_imperial_bracer_r = object_draft_schematic_armor_shared_armor_appearance_mandalorian_imperial_bracer_r:new {
   ...
   customObjectName = "Imperial Mandalorian Armor Right Bracer",
   ...
   targetTemplate = "object/draft_schematic/armor/armor_appearance_mandalorian_imperial_bracer_r.iff",
