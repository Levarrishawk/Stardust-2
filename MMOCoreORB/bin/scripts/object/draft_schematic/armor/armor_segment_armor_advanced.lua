...
object_draft_schematic_armor_armor_segment_armor_advanced = object_draft_schematic_armor_shared_armor_segment_armor_advanced:new {
	...
	targetTemplate = "object/tangible/component/armor/armor_segment_armor_advanced.iff",

	additionalTemplates = {}
}
ObjectTemplates:addTemplate(object_draft_schematic_armor_armor_segment_armor_advanced, "object/draft_schematic/armor/armor_segment_armor_advanced.iff")
