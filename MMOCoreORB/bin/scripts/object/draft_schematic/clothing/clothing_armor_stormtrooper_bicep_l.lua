...
ObjectTemplates:addTemplate(object_draft_schematic_clothing_clothing_armor_stormtrooper_bicep_l, "object/draft_schematic/armor/armor_appearance_stormtrooper_bicep_l.iff")
