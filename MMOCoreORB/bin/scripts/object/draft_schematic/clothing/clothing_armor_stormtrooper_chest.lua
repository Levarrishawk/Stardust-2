...
ObjectTemplates:addTemplate(object_draft_schematic_clothing_clothing_armor_stormtrooper_chest, "object/draft_schematic/armor/armor_appearance_stormtrooper_chest.iff")
