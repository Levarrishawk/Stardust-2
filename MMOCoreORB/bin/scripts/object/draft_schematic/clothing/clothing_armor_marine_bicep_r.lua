...
ObjectTemplates:addTemplate(object_draft_schematic_clothing_clothing_armor_marine_bicep_r, "object/draft_schematic/armor/armor_appearance_rebel_marine_bicep_r.iff")
