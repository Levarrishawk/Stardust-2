...
ObjectTemplates:addTemplate(object_draft_schematic_clothing_clothing_armor_marine_helmet, "object/draft_schematic/armor/armor_appearance_rebel_marine_helmet.iff")
