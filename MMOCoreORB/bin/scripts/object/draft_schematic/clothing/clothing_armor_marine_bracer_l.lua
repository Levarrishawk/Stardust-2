...
object_draft_schematic_clothing_clothing_armor_marine_bracer_l = object_draft_schematic_clothing_shared_clothing_armor_marine_bracer_l:new {

   templateType = DRAFTSCHEMATIC,

   customObjectName = "Marine Armor Left Bracer",
...
ObjectTemplates:addTemplate(object_draft_schematic_clothing_clothing_armor_marine_bracer_l, "object/draft_schematic/armor/armor_appearance_rebel_marine_bracer_l.iff")
