...
ObjectTemplates:addTemplate(object_draft_schematic_clothing_clothing_armor_stormtrooper_gloves, "object/draft_schematic/armor/armor_appearance_stormtrooper_gloves.iff")
