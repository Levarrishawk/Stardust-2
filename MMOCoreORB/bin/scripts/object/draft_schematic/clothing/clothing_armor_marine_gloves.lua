...
object_draft_schematic_clothing_clothing_armor_marine_gloves = object_draft_schematic_clothing_shared_clothing_armor_marine_gloves:new {

   templateType = DRAFTSCHEMATIC,

   customObjectName = "Marine Armor Gloves",
...
ObjectTemplates:addTemplate(object_draft_schematic_clothing_clothing_armor_marine_gloves, "object/draft_schematic/armor/armor_appearance_rebel_marine_gloves.iff")
