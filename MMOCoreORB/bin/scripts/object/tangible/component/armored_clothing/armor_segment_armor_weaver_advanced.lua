...
object_tangible_component_armored_clothing_armor_segment_armor_weaver_advanced = object_tangible_component_armored_clothing_shared_armor_segment_armor_weaver_advanced:new {
	...
	experimentalMax = {0, 0, 1000, 20, 1000, 0, 0, 0, 1, 1, 25, 1000},
	experimentalPrecision = {0, 0, 0, 10, 0, 0, 0, 0, 0, 0, 10, 0},
	experimentalCombineType = {0, 0, 1, 1, 1, 1, 1, 1, 4, 4, 4, 1},
}

ObjectTemplates:addTemplate(object_tangible_component_armored_clothing_armor_segment_armor_weaver_advanced, "object/tangible/component/armored_clothing/armor_segment_armor_weaver_advanced.iff")