...
object_tangible_component_armored_clothing_armor_segment_armor_weaver_cold = object_tangible_component_armored_clothing_shared_armor_segment_armor_weaver_cold:new {
	...
	experimentalMin = {0, 0, 1000, 1, 100, 0, 0, 0, 1, 64, 1, 100},
	experimentalMax = {0, 0, 1000, 20, 1000, 0, 0, 0, 1, 64, 25, 1000},
	experimentalPrecision = {0, 0, 0, 10, 0, 0, 0, 0, 0, 0, 10, 0},
	experimentalCombineType = {0, 0, 1, 1, 1, 1, 1, 1, 4, 4, 4, 1},
}

ObjectTemplates:addTemplate(object_tangible_component_armored_clothing_armor_segment_armor_weaver_cold, "object/tangible/component/armored_clothing/armor_segment_armor_weaver_cold.iff")